...
public class AdapterMyBooksList extends RecyclerView.Adapter<AdapterMyBooksList.ViewHolder>{
    ...
    public AdapterMyBooksList(Activity activity, ArrayList<ModelBookIssuedDetailsM> pojoLedgerReports) {
    ...
    @NonNull
    @Override
    public AdapterMyBooksList.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_my_books_new, parent, false);
        AdapterMyBooksList.ViewHolder viewHolder = new AdapterMyBooksList.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterMyBooksList.ViewHolder holder, int position) {
        ...
        if (list.get(position).getStatus().equals("requested")){
            ...
            holder.llStatus.setBackground(activity.getDrawable(R.drawable.half_circle_again_red));
            holder.txtBookStatus.setTextColor(activity.getColor(R.color.red_900));
            ...
            holder.llStatus.setBackground(activity.getDrawable(R.drawable.half_circle_again_green));
            holder.txtBookStatus.setTextColor(activity.getColor(R.color.green_900));
            ...
            holder.llStatus.setBackground(activity.getDrawable(R.drawable.half_circle_again_blue));
            holder.txtBookStatus.setTextColor(activity.getColor(R.color.blue_900));
        }else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public LinearLayout llDate,llStatus;
        ...
        public ViewHolder(View rowView) {
            ...
            llStatus = rowView.findViewById(R.id.llStatus);
