...
public class AdapterIssuedRequestList extends RecyclerView.Adapter<AdapterIssuedRequestList.ViewHolder>{
    ArrayList<ModelAdminIssueRequestDetails> list;
    Activity activity;
    ...
    public AdapterIssuedRequestList(Activity activity, ArrayList<ModelAdminIssueRequestDetails> pojoLedgerReports) {
    ...
    @NonNull
    @Override
    public AdapterIssuedRequestList.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_issue_request_admin, parent, false);
        AdapterIssuedRequestList.ViewHolder viewHolder = new AdapterIssuedRequestList.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterIssuedRequestList.ViewHolder holder, int position) {
    ...
    private void bookIssueRequest(String borrowid){
        if (networkState.isInternetAvailable(activity)){
            ...
            Call<ModelIssueRequestM> call = RetrofitClient
                        .getInstance().getApi().getAdminApproveIssueRequest("approve_issue",""+borrowid);//
                ...
                public void onResponse(Call<ModelIssueRequestM> call, retrofit2.Response<ModelIssueRequestM> response) {
                    ...
                    if (response.body()!=null){
                        ...
                        if(pojoOrderDetails!=null){
                            showCustomDialog(activity,"Message","Book issue request has been approved.");
