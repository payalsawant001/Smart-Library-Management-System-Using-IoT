...
public class AdapterRecentHistoryList extends RecyclerView.Adapter<AdapterRecentHistoryList.ViewHolder>{
    ArrayList<ModelAdminRecentHistoryDetails> list;
    Activity activity;
    ...
    public AdapterRecentHistoryList(Activity activity, ArrayList<ModelAdminRecentHistoryDetails> pojoLedgerReports) {
    ...
    @NonNull
    @Override
    public AdapterRecentHistoryList.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recent_history_books, parent, false);
        AdapterRecentHistoryList.ViewHolder viewHolder = new AdapterRecentHistoryList.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterRecentHistoryList.ViewHolder holder, int position) {
