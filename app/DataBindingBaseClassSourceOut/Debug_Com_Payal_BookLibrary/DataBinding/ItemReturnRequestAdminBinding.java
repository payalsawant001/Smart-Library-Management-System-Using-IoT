...
public final class ItemReturnRequestAdminBinding implements ViewBinding {
  @NonNull
  ...
  private ItemReturnRequestAdminBinding(@NonNull CardView rootView,
  ...
  @NonNull
  public static ItemReturnRequestAdminBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemReturnRequestAdminBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_return_request_admin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemReturnRequestAdminBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReturnRequestAdminBinding((CardView) rootView, btnApprove, imgProviderLogo,
